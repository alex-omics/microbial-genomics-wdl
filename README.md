...
| [rna_seq_counts](workflows/rna_seq_counts) | BWA-MEM alignment and featureCounts of paired-end RNA-seq, with each sample aligned to its own isolate's assembly and counted onto shared ortholog groups; also runs against a single shared reference | 🚧 In development |
